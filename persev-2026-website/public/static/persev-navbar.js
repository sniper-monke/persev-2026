(function () {
  ...
  const navMarkup = [
    ...
    '      <li><a class="toormix-overlay__item toormix-overlay__item--1" href="/">Home</a></li>',
    '      <li><a class="toormix-overlay__item toormix-overlay__item--2" href="/events">Events</a></li>',
    '      <li><a class="toormix-overlay__item toormix-overlay__item--3" href="/leaderboard">Leaderboard</a></li>',
    '      <li><a class="toormix-overlay__item toormix-overlay__item--4" href="/organizing-committee">Organizing committee</a></li>',
    '      <li><a class="toormix-overlay__item toormix-overlay__item--5" href="/links">Links</a></li>',
    '    </ul>',
    '  </nav>',
